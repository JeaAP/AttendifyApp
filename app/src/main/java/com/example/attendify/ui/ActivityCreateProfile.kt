...
import com.example.attendify.databasehelper.DatabaseHelperLogin
...
import com.example.attendify.model.Profile
...
//        Toast.makeText(this, "Back button is disabled on this screen.", Toast.LENGTH_SHORT).show()
    ...
    private fun saveProfile() {
        ...
        val intent = Intent(this, com.example.attendify.ui.ActivityMain::class.java)
