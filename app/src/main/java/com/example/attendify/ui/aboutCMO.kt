...
import com.example.attendify.databinding.ActivityAboutCmoBinding

class aboutCMO : AppCompatActivity() {

    private lateinit var binding: ActivityAboutCmoBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityAboutCmoBinding.inflate(layoutInflater)
